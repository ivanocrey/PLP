...
@section('main-content')
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">{{ __('UMUM') }}</h1>
    @if(session('sukses'))
                ...
                <div class="panel">
                   <table id="datatable" class="table table-hover">
                        <tr>
                            ...
                            <th>Keterangan </th>
                            <th>Action
                            <a href="{{URL::to('lokasi/sub_umum1/create')}}" class="btn btn-primary float-right">Add</a>
                            </th>
                        </tr>
                        ...
                        <tr>
                          ...
                          <th>
                            ...
                            <a href="{{URL::to('lokasi/sub_umum1/'.$lokasi->sub_id1.'/edit')}}" class="btn btn-warning">Edit</a>
