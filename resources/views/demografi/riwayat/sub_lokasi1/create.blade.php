  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      ...
      <!-- gunakan tanda [] untuk menampung array  -->
        <form action="/lokasi/sub_lokasi1/hasil" method="POST">
        {{ csrf_field()}}
          <div class="control-group after-add-more">
            ...
            <br>
            <label>Table </label>
            <input type="number" name="id_lokasi[]" class="form-control" value="1">
            <label>Nilai</label>
            <input type="number" name="nilai[]" class="form-control" placeholder="Enter Nilai">
